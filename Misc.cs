...
namespace HugsAndKisses
{
    ...
    public class Misc
    {
        ...
        public static void ShowHeart(NPC npc)
        {
            ...
            {
                new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(211, 428, 7, 6), 2000f, 1, 0, new Vector2(npc.Tile.X, npc.Tile.Y) * 64f + new Vector2(16f, -64f), false, false, 1f, 0f, Color.White, 4f, 0f, 0f, 0f, false)
                {
        ...
        public static void SetNPCRelations()
        {
            ...
            //FIX
           /*
            *   NPC Disposition fix here.......... ..... ........... 
            */

            Dictionary<string, CharacterData> NPCDispositions = Helper.GameContent.Load<Dictionary<string, CharacterData>>("Data\\Characters");
